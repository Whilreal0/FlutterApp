...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea( // ✅ Prevents overlap with camera notch/status bar
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          'Clean UI and great user experience. Built Elyu Explorer to support local tourism and provide a seamless guide for adventurers.',
